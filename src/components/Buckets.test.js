...
describe('Buckets component displays buckets correctly', () => {
  ...
  beforeEach(() => {
    const buckets = new Map([[1,[[-1,"Buckets License",500,1],[1,"Rent",0,1],[2,"Groceries",-25125,1],[3,"Car",59750,1]]],[-1,[[0,"Hobbies",47729,-1],[4,"Activities",33680,-1]]]])
    const bucketCats = {
      columns: ['id', 'name'],
  ...
  test('clicking a bucket calls handler to change view', async () => {
    ...
    const element = screen.getByText('Groceries')
