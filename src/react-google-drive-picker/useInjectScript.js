...
function useInjectScript(url) {
  ...
  ;(0, react_1.useEffect)(
    function () {
      var _a, _b, _c, _d, _e
      if (
        !((_a = injectorState.injectorMap) === null || _a === void 0
          ? void 0
          : _a[url])
      ) {
      ...
      var onScriptEvent = function (error) {
        ...
        ;(_b =
          (_a = injectorState.queue) === null || _a === void 0
            ? void 0
            : _a[url]) === null || _b === void 0
          ? void 0
          : _b.forEach(function (job) {
              return job(error)
            })
        if (error && injectorState.scriptMap[url]) {
          ;(_d =
            (_c = injectorState.scriptMap) === null || _c === void 0
              ? void 0
              : _c[url]) === null || _d === void 0
            ? void 0
            : _d.remove()
      ...
      if (
        !((_b = injectorState.scriptMap) === null || _b === void 0
          ? void 0
          : _b[url])
      ) {
      ...
      if (
        !((_c = injectorState.queue) === null || _c === void 0
          ? void 0
          : _c[url])
      ) {
        ...
        ;(_e =
          (_d = injectorState.queue) === null || _d === void 0
            ? void 0
      ...
      return function () {
        ...
        ;(_a = injectorState.scriptMap[url]) === null || _a === void 0
          ? void 0
          : _a.removeEventListener('load', function () {
              return onScriptEvent(true)
            })
        ;(_b = injectorState.scriptMap[url]) === null || _b === void 0
          ? void 0
          : _b.removeEventListener('error', function () {
              return onScriptEvent(true)
            })
      }
    },
